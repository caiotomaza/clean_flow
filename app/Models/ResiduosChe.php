<?php
    ...
    class ResiduosChe extends Model{
        use HasFactory;

        protected $table = 'residuos_ches'; // garanta que o nome da tabela esteja correto
        ...
        {
            return $this->belongsTo(Residuos::class, 'id_resd');
        }

        public function subresiduo()
        {
            return $this->belongsTo(SubResiduos::class, 'id_sub_resd');
        }
